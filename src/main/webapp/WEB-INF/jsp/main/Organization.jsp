...
<body>
    ...
    <section class="subCont">
        ...
        <div class="container">
            <div class="subDesc sub01_04">
                <h3 class="subTit02">Department</h3>
                <div class="tac"><img src="images/puble_img/sub01_04_contents.png" alt=""></div>
            </div>
        </div>
    </section>
    <footer>
