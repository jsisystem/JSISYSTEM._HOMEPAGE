	...
	<div id="container">
		...
		<!-- //좌측메뉴 끝 -->			
			...
			<div id="content">
				...
				<!-- //현재위치 네비게이션 끝 -->
				<!-- 타이틀 이미지 -->			
				<div class="content_img_div w3-opacity"><img src="<c:url value='/'/>images/subtitle/img_subtitle03-02.gif" width="776" height="230" alt="묻고/답하기 각종 문의 사항에 대한 답변을 친절하게 제공해 드리고 있습니다."/>					
				</div>
				<!-- main content 시작 -->
